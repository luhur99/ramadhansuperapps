        ...
        <div className="bg-emerald-900 rounded-[48px] overflow-hidden shadow-2xl relative border-4 border-emerald-800">
          ...
          <div className="p-8 md:p-16 flex flex-col lg:flex-row items-center gap-12 relative z-10">
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-yellow-400 text-yellow-950 font-bold text-sm rounded-full mb-6">
              ...
              <div className="flex gap-4 justify-center lg:justify-start mb-10">
                <div className="text-center">
                  <div className="bg-white/10 w-16 h-16 rounded-2xl flex items-center justify-center text-white text-2xl font-bold border border-white/20">
              ...
              <div className="mb-10 p-8 bg-white/5 rounded-[32px] border border-white/10 inline-block text-center lg:text-left">
                <div className="text-emerald-400 text-lg font-medium line-through mb-1">{CONFIG.priceBefore}</div>
                <div className="flex items-end justify-center lg:justify-start gap-2">
                  <div className="text-white text-6xl font-black">{CONFIG.priceAfter}</div>
                  <div className="text-emerald-300 text-sm font-bold pb-2">/ Akses Selamanya</div>
                </div>
                <div className="text-yellow-400 text-sm font-bold mt-4 flex items-center gap-2 justify-center lg:justify-start">
              ...
              <div className="flex flex-col gap-4 max-w-sm mx-auto lg:mx-0">
                <a 
                  ...
                  className="w-full py-6 bg-yellow-400 text-emerald-950 font-black text-2xl rounded-2xl hover:bg-yellow-300 hover:scale-105 transition-all text-center shadow-2xl shadow-yellow-400/40"
                >
